...
class TweetIconsRow extends StatelessWidget {
  ...
  Widget _tweetActionsIcons(BuildContext context, FeedModel model) {
    var authState = Provider.of<AuthState>(context, listen: false);
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _iconWidget(
            ...
            text: '',
            icon: model.likeList!.any((userId) => userId == authState.userId)
                ? AppIcon.bookmarkFill
                : AppIcon.bookmarkEmpty,
            iconColor: iconColor,
            size: size ?? 20,
            onPressed: () async {
              var state = Provider.of<FeedState>(context, listen: false);
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            customText('TV Squared for Android',
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        _tweetActionsIcons(context, model)
      ],
    );
  }
}
