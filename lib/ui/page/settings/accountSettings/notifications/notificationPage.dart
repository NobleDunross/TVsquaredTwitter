      ...
      body: ListView(
        children: const <Widget>[
          ...
          SettingRowWidget(
            ...
            showCheckBox: false,
            subtitle:
                'Display a badge with the number of notifications waiting for you inside the TV Squared app.',
          ),
          SettingRowWidget("Push notifications"),
          SettingRowWidget("SMS notifications"),
          SettingRowWidget(
            "Email notifications",
            subtitle: 'Control when how often TV Squared sends emails to you.',
          ),
        ],
      ),
    );
