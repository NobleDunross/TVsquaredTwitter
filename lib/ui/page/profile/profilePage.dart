    ...
    Utility.createLinkAndShare(
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        description: !user.bio!.contains("Edit profile")
            ? user.bio
            : "Checkout ${user.displayName}'s profile on TV Squared app",
        title: "${user.displayName} is on TV Squared app",
    ...
    return authState.isbusy
        ...
        : list == null || list.isEmpty
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ? 'You haven\'t ${isReply ? 'reply to any News' : isMedia ? 'post any media News yet' : 'post any News yet'}'
                      : '${authState.profileUserModel.userName} hasn\'t ${isReply ? 'reply to any News' : isMedia ? 'post any media News yet' : 'post any News yet'}',
